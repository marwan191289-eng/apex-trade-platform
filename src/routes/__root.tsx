...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nexus — Professional Crypto Trading" },
      { name: "description", content: "Trade 200+ cryptocurrencies with live market data and a $10,000 virtual portfolio. Bilingual English/Arabic." },
      { name: "theme-color", content: "#0B0E11" },
      { property: "og:title", content: "Nexus — Professional Crypto Trading" },
      { property: "og:description", content: "Live crypto markets, advanced trading interface, and paper trading with a virtual portfolio." },
