...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional crypto trading — 500+ assets, live charts, futures, bots, copy trading & staking. Bilingual EN/AR." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "TradeXray",
          url: "https://tradexray-v.lovable.app",
          logo: "https://tradexray-v.lovable.app/favicon.png",
          description: "Professional crypto trading platform with live markets, futures, bots, copy trading and staking.",
        }),
      },
      {
        type: "application/ld+json",
        children: JSON.stringify({
          ...
          potentialAction: {
            "@type": "SearchAction",
            target: "https://tradexray-v.lovable.app/markets?q={search_term_string}",
