...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TradeXray — Professional Crypto Trading Platform" },
      { property: "og:description", content: "TradeXray is a professional crypto trading platform with live markets for 500+ assets, advanced charts, futures, bots, copy trading and staking. Bilingual EN/AR." },
      { property: "og:image", content: "/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "TradeXray — Professional Crypto Trading Platform" },
      { name: "twitter:description", content: "TradeXray is a professional crypto trading platform with live markets for 500+ assets, advanced charts, futures, bots, copy trading and staking. Bilingual EN/AR." },
