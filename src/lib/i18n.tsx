...
const dict = {
  en: {
    ...
    "auth.login.subtitle": "Sign in to your Nexus account",
    ...
    "auth.switch.tosignup": "New to Nexus?",
    ...
    "footer.legal": "Legal",
    "footer.disclaimer": "Nexus is a paper-trading demo. No real funds are processed. Market data via CoinGecko.",
  },
  ar: {
    "nav.markets": "الأسواق",
    "nav.trade": "التداول",
    ...
    "auth.login.subtitle": "سجل دخولك إلى حساب Nexus",
    ...
    "auth.switch.tosignup": "جديد على Nexus؟",
    ...
    "footer.legal": "قانوني",
    "footer.disclaimer": "Nexus منصة تداول وهمية للعرض. لا يتم معالجة أموال حقيقية. بيانات السوق من CoinGecko.",
  },
} as const;
